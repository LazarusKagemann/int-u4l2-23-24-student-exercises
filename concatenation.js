...
submitButton.addEventListener("click", function() {
    ...
    // results.innerHTML.concat("My name is ", ". ","I'm feeling ", mood," and I absolutely lovveeee eating ", food," 😍...")

    results.innerHTML = +myName+". "+"I'm feeling "+mood+" and I absolutely lovveeee eating "+food+" 😍..."
